...
class PreferencesControllerTest < ActionController::TestCase
  ...
  test "should create preference" do
    assert_difference('Preference.count') do
      post :create, preference: { authorize_receive_email: @preference.authorize_receive_email, authorize_receive_warning: @preference.authorize_receive_warning }
    end
  ...
  test "should update preference" do
    put :update, id: @preference, preference: { authorize_receive_email: @preference.authorize_receive_email, authorize_receive_warning: @preference.authorize_receive_warning }
    assert_redirected_to preference_path(assigns(:preference))
  end
